...
export const seoConfig: Record<string, SEOProps> = {
  home: {
    title: 'قبيلة النعيم أهل الصفرا ٥١٥',
    description: 'قبيلة النعيم أهل الصفرا ٥١٥ في بلاد الشام. توثيق تاريخها ونسبها وتراث الإبل والخيل والشعر النبطي وبلدة عز الدين أبو حمرة.',
  ...
  town: {
    ...
    description: 'بلدة عزّ الدين أبو حمرة، موطن قبيلة النعيم أهل الصفرا ٥١٥ التاريخي. نتعرف على قصة البلدة ومعالمها ودورها في تاريخ القبيلة وإرثها العربي.',
  ...
  badia: {
    ...
    description: 'البادية السورية (الحماد) مهد قبيلة النعيم أهل الصفرا ٥١٥. أرض واسعة في بلاد الشام، اشتهرت بمراعيها وحياة البادية والإبل والخيل، وتحمل تاريخًا عريقًا.',
  ...
  search: {
    ...
    description: 'ابحث في موقع قبيلة السادة النعيم عن التاريخ والنسب والتراث والإبل والخيل والشعر والعادات والتقاليد والضيافة.',
