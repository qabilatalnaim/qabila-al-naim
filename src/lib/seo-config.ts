...
export const seoConfig: Record<string, SEOProps> = {
  home: {
    title: 'قبيلة السادة النعيم | تراث عربي أصيل',
    description: 'قبيلة السادة النعيم (أهل الصفرا) من القبائل العربية العريقة. نسب هاشمي، فروسية عربية، إبل صفراء، شعر نبطي، وكرم ضيافة في حمص.',
