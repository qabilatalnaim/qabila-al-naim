  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        {/* Silsilat Al-Nasb Image — شجرة النسب بجودة عالية Q92 */}
        <div className="max-w-4xl mx-auto mb-12">
              ...
              <div className="w-full md:w-1/2 flex flex-col justify-center">
                ...
                <div className="mt-4 text-xs text-gray-500">
                  <span className="inline-flex items-center gap-1">
                    <span>🎨</span>
                    <span>جودة عالية: 2201×3113 px · WebP Q92</span>
                  </span>
                </div>
              </div>
              <div className="w-full md:w-1/2">
                <figure className="relative group">
                  <div className="relative rounded-2xl overflow-hidden border-2 border-[#D4AF37]/30 shadow-[0_0_40px_rgba(212,175,55,0.2)]">
                    <picture>
                      <source media="(max-width: 768px)" srcSet="/images/silsilat-al-nasb-hashimi-2026-mobile.webp" />
                      <source srcSet="/images/silsilat-al-nasb-hashimi-2026.webp" type="image/webp" />
                      <img
                        src="/images/silsilat-al-nasb-hashimi-2026.webp"
                        alt="شجرة نسب قبيلة النعيم أهل الصفرا ٥١٥ - سلسلة النسب الهاشمي الرفاعي الموسوي الحسيني، من رفاعة إلى الإمام علي رضي الله عنه"
                    ...
                    <div className="absolute bottom-0 right-0 left-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform">
                      <div className="bg-[#0a1628]/80 backdrop-blur-md rounded-xl p-3 border border-[#D4AF37]/30">
                        <p className="text-[#D4AF37] text-sm font-bold text-center">سلسلة النسب الهاشمي</p>
                        <p className="text-gray-300 text-xs text-center">الرفاعية ← الموسوية ← الحسينية</p>
                      </div>
                    </div>
                  </div>
                  {/* Caption أسفل الصورة */}
                  <figcaption className="text-center mt-4">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#D4AF37]/5 border border-[#D4AF37]/20">
                      ...
                      <span className="text-sm font-medium text-gray-300">
                        شجرة نسب <span className="text-[#D4AF37] font-bold">قبيلة النعيم أهل الصفرا ٥١٥</span> — سلسلة النسب الهاشمي
                      </span>
                    </div>
                  </figcaption>
                </figure>
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="bg-gradient-to-br from-[#0a1628] to-[#162544] rounded-3xl p-8 md:p-12 border border-[#D4AF37]/20">
            ...
            {/* شجرة آل الرفاعي — بجودة عالية */}
            <figure className="mt-8 relative group">
              <div className="relative rounded-2xl overflow-hidden border-2 border-[#D4AF37]/30 shadow-[0_0_40px_rgba(212,175,55,0.2)]">
                <picture>
                  <source media="(max-width: 768px)" srcSet="/images/al-rafai-tree-2026-mobile.webp" />
                  <source srcSet="/images/al-rafai-tree-2026.webp" type="image/webp" />
                  <img
                    src="/images/al-rafai-tree-2026.webp"
                    alt="شجرة نسب آل الرفاعي - من الحسن المكي (رفاعة) إلى هاشم القرشي، السلسلة الرفاعية الموسوية الحسينية"
                    className="w-full h-auto object-contain transition-transform duration-700 group-hover:scale-[1.02]"
                    loading="lazy"
                    decoding="async"
                  />
                ...
                <div className="absolute bottom-0 right-0 left-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform">
                  <div className="bg-[#0a1628]/80 backdrop-blur-md rounded-xl p-3 border border-[#D4AF37]/30">
                    <p className="text-[#D4AF37] text-sm font-bold text-center">شجرة نسب آل الرفاعي</p>
                    <p className="text-gray-300 text-xs text-center">من الحسن المكي (رفاعة) إلى هاشم القرشي</p>
                  </div>
                </div>
              </div>
              <figcaption className="text-center mt-4">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#D4AF37]/5 border border-[#D4AF37]/20">
                  <span className="text-sm">🌳</span>
                  <span className="text-sm font-medium text-gray-300">
                    شجرة نسب <span className="text-[#D4AF37] font-bold">آل الرفاعي</span> — من رفاعة إلى هاشم القرشي
                  </span>
                </div>
                <div className="mt-2 text-xs text-gray-500">
                  <span className="inline-flex items-center gap-1">
                    <span>🎨</span>
                    <span>جودة عالية: 2203×3111 px · WebP Q92</span>
                  </span>
                </div>
              </figcaption>
            </figure>
          ...
          <div className="bg-gradient-to-br from-[#0a1628] to-[#162544] rounded-3xl p-8 md:p-12 border border-[#D4AF37]/20">
            ...
            {/* شجرة تسلسل النسب بعد رفاعة — بجودة عالية */}
            <figure className="mt-8 relative group">
              <div className="relative rounded-2xl overflow-hidden border-2 border-[#D4AF37]/30 shadow-[0_0_40px_rgba(212,175,55,0.2)]">
                <picture>
                ...
                <div className="absolute bottom-0 right-0 left-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform">
                  <div className="bg-[#0a1628]/80 backdrop-blur-md rounded-xl p-3 border border-[#D4AF37]/30">
                    <p className="text-[#D4AF37] text-sm font-bold text-center">تسلسل النسب بعد رفاعة</p>
                    <p className="text-gray-300 text-xs text-center">من الحسن المكي إلى عبد الله المدني وعسلة وثابت</p>
                  </div>
                </div>
              </div>
              <figcaption className="text-center mt-4">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#D4AF37]/5 border border-[#D4AF37]/20">
                  <span className="text-sm">👑</span>
                  <span className="text-sm font-medium text-gray-300">
                    شجرة <span className="text-[#D4AF37] font-bold">تسلسل النسب بعد رفاعة</span> — من الحسن المكي إلى الأبناء الثلاثة
                  </span>
                </div>
                <div className="mt-2 text-xs text-gray-500">
                  <span className="inline-flex items-center gap-1">
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="bg-gradient-to-br from-[#0a1628] to-[#162544] rounded-3xl p-8 md:p-12 border border-[#D4AF37]/20">
            ...
            {/* شجرة حياته الأسرية — بجودة عالية */}
            <figure className="mt-8 relative group">
              <div className="relative rounded-2xl overflow-hidden border-2 border-[#D4AF37]/30 shadow-[0_0_40px_rgba(212,175,55,0.2)]">
                <picture>
                ...
                <div className="absolute bottom-0 right-0 left-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform">
                  <div className="bg-[#0a1628]/80 backdrop-blur-md rounded-xl p-3 border border-[#D4AF37]/30">
                    <p className="text-[#D4AF37] text-sm font-bold text-center">حياة عز الدين أبو حمرة الأسرية</p>
                    <p className="text-gray-300 text-xs text-center">4 زوجات · 8 أبناء · كليلة وحمرة</p>
                  </div>
                </div>
              </div>
              <figcaption className="text-center mt-4">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#D4AF37]/5 border border-[#D4AF37]/20">
                  <span className="text-sm">👨‍👩‍👧‍👦</span>
                  <span className="text-sm font-medium text-gray-300">
                    شجرة <span className="text-[#D4AF37] font-bold">حياته الأسرية</span> — الزوجات والأبناء
                  </span>
                </div>
                <div className="mt-2 text-xs text-gray-500">
                  <span className="inline-flex items-center gap-1">
