  ...
  return (
    <div className="min-h-screen bg-[#0a1628]">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        {/* ملحمة النعيم - Poem Section */}
        <div className="max-w-5xl mx-auto mb-16">
          <div className="bg-gradient-to-br from-[#1a1520] to-[#0a1628] rounded-3xl p-8 md:p-12 border border-[#D4AF37]/30">
            <div className="text-center mb-8">
              <span className="text-4xl mb-4 block">📜</span>
              <h2 className="text-3xl font-bold text-[#D4AF37] mb-2">ملحمة النعيم</h2>
            ...
            <section className="poem space-y-8">
              {/* Opening */}
              <div className="text-center">
                <h3 className="text-2xl font-bold text-[#D4AF37] mb-4">✦ الافتتاح المبارك ✦</h3>
              ...
              {/* راية آل البيت */}
              <div className="text-center">
                <h3 className="text-2xl font-bold text-[#D4AF37] mb-4">✦ راية آل البيت ✦</h3>
                <p className="text-gray-200 text-xl leading-loose mb-2">
              ...
              {/* عزّ النعيم */}
              <div className="text-center">
                <h3 className="text-2xl font-bold text-[#D4AF37] mb-4">✦ عزّ النعيم ✦</h3>
                <p className="text-gray-200 text-xl leading-loose mb-2">
              ...
              {/* صهيل الوغى */}
              <div className="text-center">
                <h3 className="text-2xl font-bold text-[#D4AF37] mb-4">✦ صهيل الوغى ✦</h3>
                <p className="text-gray-200 text-xl leading-loose mb-2">
              ...
              {/* أثر الهجن */}
              <div className="text-center">
                <h3 className="text-2xl font-bold text-[#D4AF37] mb-4">✦ أثر الهجن ✦</h3>
                <p className="text-gray-200 text-xl leading-loose mb-2">
              ...
              {/* يوم الهيّه */}
              <div className="text-center">
                <h3 className="text-2xl font-bold text-[#D4AF37] mb-4">✦ يوم الهيّه ✦</h3>
                <p className="text-gray-200 text-xl leading-loose mb-2">
