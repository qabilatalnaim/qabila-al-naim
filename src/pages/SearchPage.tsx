...
export default function SearchPage() {
  ...
  return (
    <>
      <SEO
        title="بحث في الموقع | قبيلة النعيم أهل الصفرا ٥١٥"
        description="ابحث في محتوى موقع قبيلة النعيم أهل الصفرا ٥١٥ - التراث، التاريخ، النسب، الإبل، الخيل، الشعر، والضيافة."
