    ...
    <>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          {/* بيت الشعر البدوي - بانوراما مسائية مع رجال البادية */}
          <figure className="mb-12 relative rounded-3xl overflow-hidden border-2 border-yellow-500/40 shadow-[0_0_50px_rgba(234,179,8,0.3)]">
            <picture>
              ...
              <img
                ...
                srcSet="/images/masweb-tent-2026-400w.webp 400w, /images/masweb-tent-2026-800w.webp 800w, /images/masweb-tent-2026-1200w.webp 1200w, /images/masweb-tent-2026-1600w.webp 1600w, /images/masweb-tent-2026-2000w.webp 2000w"
                sizes="(max-width: 480px) 100vw, (max-width: 768px) 100vw, (max-width: 1280px) 90vw, 1200px"
                alt="بيت الشعر البدوي في البادية السورية عند غروب الشمس - رجال البادية بثوبهم التقليدي مجتمعين حول النار مع دلة القهوة، إبل الصحراء في الخلفية، زهور برية صحراوية، خيمة من شعر الماعز مع فوانيس"
            ...
            <figcaption className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-[#0a1628] via-[#0a1628]/70 to-transparent px-3 md:px-6 py-3 md:py-4">
              <p className="text-center text-white text-xs sm:text-sm md:text-base font-bold drop-shadow-[0_2px_6px_rgba(0,0,0,0.9)]">
                بيت الشعر في البادية — مجلس القهوة والكرم عند الغروب
              </p>
            </figcaption>
          </figure>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="bg-yellow-600/10 rounded-xl p-6 border border-yellow-600/30">
                    ...
                    {/* صورة توضيحية للقطبة - بيت بعمود واحد */}
                    {item.name === 'القطبة' && (
                      <figure className="mt-4 relative rounded-2xl overflow-hidden border-2 border-yellow-500/40">
                        <picture>
                          <source
                            type="image/avif"
                            srcSet="/images/qatba-tent-2026-400w.avif 400w, /images/qatba-tent-2026-800w.avif 800w, /images/qatba-tent-2026-1200w.avif 1200w, /images/qatba-tent-2026-1600w.avif 1600w, /images/qatba-tent-2026-2000w.avif 2000w"
                            sizes="(max-width: 480px) 100vw, (max-width: 768px) 100vw, 1200px"
                          />
                          <source
                            type="image/webp"
                            srcSet="/images/qatba-tent-2026-400w.webp 400w, /images/qatba-tent-2026-800w.webp 800w, /images/qatba-tent-2026-1200w.webp 1200w, /images/qatba-tent-2026-1600w.webp 1600w, /images/qatba-tent-2026-2000w.webp 2000w"
                            sizes="(max-width: 480px) 100vw, (max-width: 768px) 100vw, 1200px"
                          />
                          <img
                            src="/images/qatba-tent-2026-2000w.webp"
                            srcSet="/images/qatba-tent-2026-400w.webp 400w, /images/qatba-tent-2026-800w.webp 800w, /images/qatba-tent-2026-1200w.webp 1200w, /images/qatba-tent-2026-1600w.webp 1600w, /images/qatba-tent-2026-2000w.webp 2000w"
                            sizes="(max-width: 480px) 100vw, (max-width: 768px) 100vw, 1200px"
                            alt="القطبة - بيت الشعر البدوي بعمود واحد مقسم إلى قسمين في البادية السورية - مجلس قهوة بدوي تقليدي عند الغروب مع جمال في الخلفية"
                            className="w-full h-auto object-cover"
                            loading="lazy"
                            decoding="async"
                            width="2752"
                        ...
                        <figcaption className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-[#0a1628] via-[#0a1628]/70 to-transparent px-3 py-2">
                          <p className="text-center text-white text-xs sm:text-sm font-bold drop-shadow-[0_2px_6px_rgba(0,0,0,0.9)]">
                            🏕️ القطبة — عمود واحد (الواسط) يقسم البيت إلى قسمين
                          </p>
                        </figcaption>
                      </figure>
                    )}

                    {/* صورة توضيحية للصهوة - بيت بعمودين */}
                    {item.name === 'الصهوة' && (
                      <figure className="mt-4 relative rounded-2xl overflow-hidden border-2 border-yellow-500/40">
                        <picture>
                          <source
                            type="image/avif"
                            srcSet="/images/sahwa-tent-2026-400w.avif 400w, /images/sahwa-tent-2026-800w.avif 800w, /images/sahwa-tent-2026-1200w.avif 1200w, /images/sahwa-tent-2026-1600w.avif 1600w, /images/sahwa-tent-2026-2000w.avif 2000w"
                            sizes="(max-width: 480px) 100vw, (max-width: 768px) 100vw, 1200px"
                          />
                          <source
                            type="image/webp"
                            srcSet="/images/sahwa-tent-2026-400w.webp 400w, /images/sahwa-tent-2026-800w.webp 800w, /images/sahwa-tent-2026-1200w.webp 1200w, /images/sahwa-tent-2026-1600w.webp 1600w, /images/sahwa-tent-2026-2000w.webp 2000w"
                            sizes="(max-width: 480px) 100vw, (max-width: 768px) 100vw, 1200px"
                          />
                          <img
                            src="/images/sahwa-tent-2026-2000w.webp"
                            srcSet="/images/sahwa-tent-2026-400w.webp 400w, /images/sahwa-tent-2026-800w.webp 800w, /images/sahwa-tent-2026-1200w.webp 1200w, /images/sahwa-tent-2026-1600w.webp 1600w, /images/sahwa-tent-2026-2000w.webp 2000w"
                            sizes="(max-width: 480px) 100vw, (max-width: 768px) 100vw, 1200px"
                            alt="الصهوة - بيت الشعر البدوي بعمودين مقسم إلى ثلاثة أقسام في البادية السورية - مجلس ضيافة بدوي عند الغروب مع جمال في الخلفية وفوانيس ودلة قهوة تقليدية"
                            className="w-full h-auto object-cover"
                            loading="lazy"
                            decoding="async"
                            width="1672"
                        ...
                        <figcaption className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-[#0a1628] via-[#0a1628]/70 to-transparent px-3 py-2">
                          <p className="text-center text-white text-xs sm:text-sm font-bold drop-shadow-[0_2px_6px_rgba(0,0,0,0.9)]">
                            🏕️ الصهوة — عمودان يقسّمان البيت إلى ثلاثة أقسام
                          </p>
                        </figcaption>
                      </figure>
                    )}

                    {/* صورة توضيحية للمثوّلث - بيت بثلاثة أعمدة */}
                    {item.name === 'المثوّلث' && (
                      <figure className="mt-4 relative rounded-2xl overflow-hidden border-2 border-yellow-500/40">
                        <picture>
                          <source
                            type="image/avif"
                            srcSet="/images/motholath-tent-2026-400w.avif 400w, /images/motholath-tent-2026-800w.avif 800w, /images/motholath-tent-2026-1200w.avif 1200w, /images/motholath-tent-2026-1600w.avif 1600w, /images/motholath-tent-2026-2000w.avif 2000w"
                            sizes="(max-width: 480px) 100vw, (max-width: 768px) 100vw, 1200px"
                          />
                          <source
                            type="image/webp"
                            srcSet="/images/motholath-tent-2026-400w.webp 400w, /images/motholath-tent-2026-800w.webp 800w, /images/motholath-tent-2026-1200w.webp 1200w, /images/motholath-tent-2026-1600w.webp 1600w, /images/motholath-tent-2026-2000w.webp 2000w"
                            sizes="(max-width: 480px) 100vw, (max-width: 768px) 100vw, 1200px"
                          />
                          <img
                            src="/images/motholath-tent-2026-2000w.webp"
                            srcSet="/images/motholath-tent-2026-400w.webp 400w, /images/motholath-tent-2026-800w.webp 800w, /images/motholath-tent-2026-1200w.webp 1200w, /images/motholath-tent-2026-1600w.webp 1600w, /images/motholath-tent-2026-2000w.webp 2000w"
                            sizes="(max-width: 480px) 100vw, (max-width: 768px) 100vw, 1200px"
                            alt="المثوّلث - بيت الشعر البدوي بثلاثة أعمدة مقسم إلى أربعة أقسام في البادية السورية - بيت ضيافة كبير مع 3 أعمدة خشبية ومجلس قهوة ونار وجمال في الخلفية عند الغروب"
                            className="w-full h-auto object-cover"
                            loading="lazy"
                            decoding="async"
                            width="1672"
                        ...
                        <figcaption className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-[#0a1628] via-[#0a1628]/70 to-transparent px-3 py-2">
                          <p className="text-center text-white text-xs sm:text-sm font-bold drop-shadow-[0_2px_6px_rgba(0,0,0,0.9)]">
                            🏕️ المثوّلث — ثلاثة أعمدة تقسّم البيت إلى أربعة أقسام
                          </p>
                        </figcaption>
                      </figure>
                    )}
                    ...
                    {/* صورة توضيحية للمخومس - بيت بخمسة أعمدة */}
                    {item.name === 'المخومس' && (
                      <figure className="mt-4 relative rounded-2xl overflow-hidden border-2 border-yellow-500/40">
                        <picture>
                          <source
                            type="image/avif"
                            srcSet="/images/mokhamas-tent-2026-400w.avif 400w, /images/mokhamas-tent-2026-800w.avif 800w, /images/mokhamas-tent-2026-1200w.avif 1200w, /images/mokhamas-tent-2026-1600w.avif 1600w, /images/mokhamas-tent-2026-2000w.avif 2000w"
                            sizes="(max-width: 480px) 100vw, (max-width: 768px) 100vw, 1200px"
                          />
                          <source
                            type="image/webp"
                            srcSet="/images/mokhamas-tent-2026-400w.webp 400w, /images/mokhamas-tent-2026-800w.webp 800w, /images/mokhamas-tent-2026-1200w.webp 1200w, /images/mokhamas-tent-2026-1600w.webp 1600w, /images/mokhamas-tent-2026-2000w.webp 2000w"
                            sizes="(max-width: 480px) 100vw, (max-width: 768px) 100vw, 1200px"
                          />
                          <img
                            src="/images/mokhamas-tent-2026-2000w.webp"
                            srcSet="/images/mokhamas-tent-2026-400w.webp 400w, /images/mokhamas-tent-2026-800w.webp 800w, /images/mokhamas-tent-2026-1200w.webp 1200w, /images/mokhamas-tent-2026-1600w.webp 1600w, /images/mokhamas-tent-2026-2000w.webp 2000w"
                            sizes="(max-width: 480px) 100vw, (max-width: 768px) 100vw, 1200px"
                            alt="المخومس - بيت الشعر البدوي بخمسة أعمدة مقسم إلى ستة أقسام في البادية السورية - بيت ضيافة فاخر مع 5 أعمدة خشبية ومجلس قهوة ونار وجمال في الخلفية عند الغروب"
                            className="w-full h-auto object-cover"
                            loading="lazy"
                            decoding="async"
                            width="1672"
                        ...
                        <figcaption className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-[#0a1628] via-[#0a1628]/70 to-transparent px-3 py-2">
                          <p className="text-center text-white text-xs sm:text-sm font-bold drop-shadow-[0_2px_6px_rgba(0,0,0,0.9)]">
                            🏕️ المخومس — خمسة أعمدة تقسّم البيت إلى ستة أقسام
                          </p>
                        </figcaption>
                      </figure>
                    )}
