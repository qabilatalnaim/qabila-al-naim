  ...
  return (
    <>
      <SEO {...seoConfig.camels} faq={[
        { question: 'ما هي سلالة إبل قبيلة النعيم؟', answer: 'قبيلة السادة النعيم اشتهرت بسلالات الإبل الصغراء الأصيلة المعروفة بجمالها وقوتها وقدرتها على التأقلم مع البيئة الصحراوية.' },
      ...
      <section className="py-20 bg-[#0a1628]">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Introduction - Updated with user's text */}
            <div className="bg-gradient-to-br from-[#162544] to-[#0a1628] rounded-3xl p-10 md:p-14 border border-[#D4AF37]/30 mb-16">
              ...
              <div className="text-gray-200 text-lg leading-loose space-y-6">
                ...
                <p>
                  ويُعرف أبناء القبيلة بـ "أهل الصفرا"، وهي نخوة ارتبطت بالإبل الصفراء الأصيلة التي كانت تمثّل رمز الهيبة والعزّ في البادية، فأصبحت هذه التسمية جزءًا من الهوية التراثية لقبيلة النعيم ودلالةً على الأصالة والفخر والانتماء. وقد ظلّت الإبل حاضرة في حياة القبيلة بوصفها عنوانًا للقوة والكرم والمكانة الرفيعة بين القبائل العربية.
                </p>
                <p>
                  كما احتلت الإبل مكانة خاصة في المجالس والولائم والمناسبات الاجتماعية والتراثية، وارتبطت بالشعر النبطي والموروث الشعبي الذي وثّق حياة البادية وقيمها الأصيلة عبر الأجيال. وتتميّز إبل النعيم بقوة تحمّلها وتأقلمها مع البيئة الصحراوية، إلى جانب العناية الكبيرة التي يوليها المربّون للحفاظ على السلالات الأصيلة والإرث البدوي العريق.
                </p>
                <p>
                  ولا تزال الإبل حتى اليوم جزءًا مهمًا من هوية أبناء النعيم وتراثهم، ورمزًا للعزّة والأصالة الممتدة في تاريخ القبيلة عبر البادية وبلاد الشام.
                </p>
              </div>
              <div className="mt-10 bg-amber-600/10 rounded-2xl p-8 border border-amber-600/30 text-center">
                <p className="text-amber-400 font-bold text-2xl">"أهل الصفرا"</p>
                <p className="text-gray-400 mt-3">نخوة قبيلة النعيم المرتبطة بالإبل الصفراء الأصيلة</p>
              </div>
            </div>
