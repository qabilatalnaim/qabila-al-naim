        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-[#0a1628] to-[#162544] rounded-3xl p-10 border border-blue-600/30 mb-12">
            ...
            <p className="text-gray-200 text-lg leading-loose text-center mb-6">
              تُعدّ الغنم من أهم المواشي التي تربيها قبائل البادية، وتُعتبر مصدراً رئيسياً للغذاء والكسوة والدخل.
              وفي قبيلة النعيم، عُرفت غنمهم بجودتها وجمال سلالتها.
            </p>
            <div className="bg-blue-600/10 rounded-2xl p-6 border border-blue-600/30 text-center">
              <p className="text-blue-400 font-bold text-xl">"غنم قبيلة النعيم سلالة نادرة"</p>
              <p className="text-gray-400 text-sm mt-2">من أوصاف الغنم العريقة</p>
            </div>
          </div>
