...
import { useSheepPlaylist, LatestVideo } from '../lib/useSocialStats'
...
export default function SheepPage() {
  // قائمة تشغيل "غنم قبيلة النعيم" - ديناميكية من YouTube
  const { videos: playlistVideos, data: playlistData, loading: videosLoading, refresh: refreshPlaylist } = useSheepPlaylist()
  ...
  return (
    <>
      ...
      {/* ═══════════════════════════════════════════════════════════
          قسم قائمة تشغيل الغنم - ديناميكي من YouTube
          ═══════════════════════════════════════════════════════════ */}
      <div className="max-w-6xl mx-auto mt-20 mb-12 px-4">
        <div className="text-center mb-8 md:mb-10">
          <div className="inline-flex items-center gap-3 bg-gradient-to-r from-red-600/20 to-pink-500/20 px-6 py-2.5 rounded-full border border-red-500/40 mb-4">
            <span className="text-2xl">🐑</span>
            <span className="text-lg md:text-xl font-bold text-pink-300">قائمة تشغيل الغنم — فيديوهات مختارة</span>
          </div>
          <h2 className="text-3xl md:text-4xl font-black text-white mb-3">
            تعرّف على غنم القبيلة عبر الشاشة
          </h2>
          <p className="text-base md:text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
            مجموعة منتقاة من فيديوهات القناة تتناول سلالات الغنم، رعايتها، جزّ صوفها، ومراعيها في حياة قبيلة السادة النعيم
          </p>
          {playlistData && (
            <div className="mt-5 flex flex-wrap items-center justify-center gap-2 md:gap-3 text-xs md:text-sm">
              ...
              <span className="inline-flex items-center gap-1.5 bg-white/5 border border-white/10 text-gray-300 px-3 py-1.5 rounded-full">
                <span className={`w-2 h-2 rounded-full ${playlistData.source === 'live' ? 'bg-pink-400 animate-pulse' : 'bg-amber-400'}`}></span>
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 bg-pink-500/15 hover:bg-pink-500/25 border border-pink-500/40 text-pink-300 hover:text-white px-3 py-1.5 rounded-full font-bold transition-all disabled:opacity-50"
        ...
        {videosLoading && (
          <div className="text-center py-12">
            <div className="inline-block w-12 h-12 border-4 border-pink-500/30 border-t-pink-400 rounded-full animate-spin"></div>
        ...
        {!videosLoading && playlistVideos.length > 0 && (
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2">
              <div className="bg-gradient-to-br from-[#162544] to-[#0a1628] rounded-3xl overflow-hidden border-2 border-pink-500/30 shadow-[0_0_40px_rgba(236,72,153,0.2)]">
                <div className="relative aspect-video bg-black">
                  {activeVideoId ? (
                    <iframe
                      key={activeVideoId}
                      src={`https://www.youtube-nocookie.com/embed/${activeVideoId}?rel=0&modestbranding=1&hl=ar`}
                      title="مشغل فيديو الغنم"
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                        ...
                        <p className="text-white text-xl font-bold mb-2">قائمة تشغيل الغنم</p>
                ...
                <div className="p-4 md:p-5">
                  ...
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    ...
                    <a
                      href={playlistData?.playlistUrl || 'https://www.youtube.com/playlist?list=PLkJUzCOLsXAOFn8aOURZWnIiHabcNMBzY'}
                      target="_blank"
                    ...
                    return (
                      <button
                        ...
                        className={`w-full text-right flex gap-2 md:gap-3 p-2 rounded-xl transition-all group ${
                          isActive
                            ? 'bg-pink-500/15 border-2 border-pink-400 shadow-[0_0_20px_rgba(236,72,153,0.3)]'
        ...
        <div className="mt-8 text-center">
          <a
            href="https://www.youtube.com/playlist?list=PLkJUzCOLsXAOFn8aOURZWnIiHabcNMBzY"
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            <span className="text-2xl">🐑</span>
            <span>شاهد قائمة "غنم قبيلة النعيم" كاملة على يوتيوب</span>
            <span>↗</span>
          </a>
        </div>
      </div>
