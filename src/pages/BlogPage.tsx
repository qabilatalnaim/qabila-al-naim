...
export default function BlogPage() {
  ...
  return (
    <>
      <SEO
        title="المدونة | قبيلة النعيم أهل الصفرا ٥١٥"
        description="أخبار ومقالات عن تاريخ وتراث قبيلة النعيم أهل الصفرا ٥١٥. مقالات تثقيفية عن الإبل، الخيل، النسب، بلدة عز الدين، الشعر النبطي، والضيافة."
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                مقالات تثقيفية ودراسات عن تاريخ وتراث قبيلة النعيم أهل الصفرا ٥١٥
              </p>
            </div>
